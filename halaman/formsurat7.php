...
<div class="card">
   ...
   <form class="form-horizontal" method="post" enctype="multipart/form-data">
      <div class="card-body">
         <div class="form-group row mb-2">
            ...
            <div class="col-sm-10">
               <input type="text" class="form-control" name="jenissurat" placeholder="Surat Keterangan Belum Menikah" value="Surat Keterangan Belum Menikah" readonly>
            </div>
         </div>
         <div class="form-group row mb-2">
   ...
   <?php
   if (isset($_POST['save'])) {
      $connect->query("INSERT INTO tb_surat (id_pengguna,jenis_surat,keperluan,keterangan) VALUES('{$_SESSION['idpengguna']}','$_POST[jenissurat]','$_POST[keperluan]','$_POST[ket]')");
