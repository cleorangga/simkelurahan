...
<div class="card">
   ...
   <form class="form-horizontal" method="post" enctype="multipart/form-data">
      <div class="card-body">
         <div class="form-group row mb-2">
            ...
            <div class="col-sm-8">
               <input type="text" class="form-control" name="jenissurat" placeholder="Surat Izin Keramaian" value="Surat Izin Keramaian" readonly>
            </div>
         </div>
         <div class="form-group row mb-2">
         ...
         <div class="form-group row mb-2">
            <label class="col-sm-4 col-form-label">Acara/Kegiatan</label>
            <div class="col-sm-8">
               <input type="text" class="form-control" name="kegiatan" required>
            </div>
         </div>
         <div class="form-group row mb-2">
            <label class="col-sm-4 col-form-label">Waktu Kegiatan</label>
            <div class="col-sm-8">
               <input  type="date" class="form-control" name="waktukegiatan" max="2999-12-31" required>
            </div>
         </div>
         <div class="form-group row mb-2">
            <label class="col-sm-4 col-form-label">Tempat Kegiatan</label>
            <div class="col-sm-8">
               <input type="text" class="form-control" name="tempatkegiatan" required>
            </div>
         </div>
         <div class="form-group row mb-2">
   ...
   <?php
   if (isset($_POST['save'])) {
      $connect->query("INSERT INTO tb_surat (id_pengguna,jenis_surat,kegiatan,waktu_kegiatan,tempat_kegiatan,keterangan) VALUES('{$_SESSION['idpengguna']}','$_POST[jenissurat]','$_POST[kegiatan]','$_POST[waktukegiatan]','$_POST[tempatkegiatan]','$_POST[ket]')");
