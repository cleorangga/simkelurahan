...
<head>
   ...
   <link rel="stylesheet" href="assets/surat1/base.min.css" />
   <link rel="stylesheet" href="assets/surat1/fancy.min.css" />
   <link rel="stylesheet" href="assets/surat1/main.css" />
   <script src="assets/surat1/compatibility.min.js"></script>
   <script src="assets/surat1/theViewer.min.js"></script>
   <script>
      try {
...
<body>
   ...
   <div id="page-container">
      <div id="pf1" class="pf w0 h0" data-page-no="1">
         <div class="pc pc1 w0 h0"><img class="bi x0 y0 w1 h1" alt="" src="assets/surat1/bg1.png" />
            ...
            <div class="t m0 x6 h6 y6 ff3 fs3 fc0 sc0 ls0 ws0">SURAT KETERANGAN USAHA</div>
            ...
            <div class="t m0 x9 h7 y13 ff4 fs4 fc0 sc0 ls0 ws0">memiliki:</div>
            <div class="t m0 x8 h7 y14 ff4 fs4 fc0 sc0 ls0 ws0">Usaha<span class="_ _a"> </span>: <strong><?php echo $row['nama_usaha']; ?></strong></div>
            <div class="t m0 x8 h7 y15 ff4 fs4 fc0 sc0 ls0 ws0">Alamat<span class="_ _b"> </span>: <?php echo $row['alamat_usaha']; ?></div>
